        ...
        <Modal isOpen={modalOpen} onRequestClose={() => setModalOpen(false)}>
          <div className={styles.modalContainer}>
            ...
            <p className={styles.aboutDescription}>
              <i>It's Someone's Favorite Song</i> explores the emotional,
              social, and cultural ties we have to music. Music is deeply woven
              into our lives, holding a mirror to our joys, our sorrows, our
              best memories, our worst ones. It can remind us of the people we
              love, the places that are special to us, and the pivotal times of
              our life. Each person has a unique experience with their favorite
              song, and the same song can mean so many different things to so
              many different people.
            </p>
            <p className={styles.aboutDescription}>
              This project aims to showcase how songs mark our personal
              histories and how we can foster more meaningful connection through
              music. It invites you to reflect on the place music holds in your
              life; to read about how your favorite song has also touched a
              stranger's life as much as it has yours; or to simply find some
              great beats.
            </p>
            <p className={styles.aboutDescription}>
        ...
        >
          <div className={styles.modalContainer}>
            ...
            <p className={styles.aboutDescription}>
              ...
              song search functionality and to play music through the Spotify
              web player. All submissions are anonymized and have no way of
              being traced to the user. By choosing to submit an entry, you
              consent to the public display of your entry.
            </p>
            <p className={styles.aboutDescription}>
              ...
              or used maliciously, if you would like to revoke the app's
              permissions, you can visit{' '}
